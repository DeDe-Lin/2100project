...
param($hostaddr,$filecount,$WatchFolder)
...
$writer.WriteLine("Subject:  $hostaddr to many error ($filecount)")
$writer.WriteLine("") 
#$writer.WriteLine("TEST")
$writer.WriteLine("$WatchFolder too many error,")
$writer.WriteLine("please check the file in the path")
$writer.WriteLine(".")
Read-MultiLineResponse $reader
